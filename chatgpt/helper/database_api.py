...
coupon_collection = db[config.COUPON_COLLECTION_NAME]
...
def get_coupon(coupon_code: str) -> Any:
    '''
    Get user
    ...
    result = coupon_collection.find_one(
        {
            'code': coupon_code,
            'used': False
        }
...
def update_coupon(coupon_code: str, update: dict) -> bool:
    '''
    Update messages for the user and reduce the messages_count by one
    ...
    result = coupon_collection.find_one_and_update(
        {
            'code': coupon_code,
            'used': False
        },
...
def update_user(sender_id: str, update: dict) -> bool:
    '''
    Update messages for the user and reduce the messages_count by one
